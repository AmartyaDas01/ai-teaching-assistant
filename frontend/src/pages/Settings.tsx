        ...
        <div className="mx-auto max-w-xl space-y-6">
          <div className="rounded-2xl border border-white/10 bg-surface p-5 shadow-card">
            <div className="mb-1 flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-slate-100">Language model</h2>
            </div>
            ...
            {data && (
              <div className="mt-4 rounded-lg bg-white/5 px-3 py-2 text-xs text-muted">
                Active: <span className="font-semibold text-slate-200">{data.provider}</span>
